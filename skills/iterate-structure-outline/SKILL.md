...
description: iterate on structure outline based on user feedback. if given a path to a document in .humanlayer/tasks/*/*-structure-outline.md, use this skill. Don't use if you already used create-structure-outline
---
